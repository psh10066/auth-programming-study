...
public class PaperSolveTest extends WithPaperTemplateTest {
    ...
    void before() {
        ...
        this.student1 = this.userTestHelper.createStudent(school, teacher, "student1", "중1");
    ...
    void 상태에_따라_시험지가_조회된다() {
        assertEquals(1, paperService.getPapersByUserState(student1.getUserId(), List.of(Paper.PaperState.READY, Paper.PaperState.START)).size());
        assertEquals(0, paperService.getPapersByUserState(student1.getUserId(), Paper.PaperState.END).size());
        ...
        assertEquals(0, paperService.getPapersByUserState(student1.getUserId(), List.of(Paper.PaperState.READY, Paper.PaperState.START)).size());
        assertEquals(1, paperService.getPapersByUserState(student1.getUserId(), Paper.PaperState.END).size());
    }
