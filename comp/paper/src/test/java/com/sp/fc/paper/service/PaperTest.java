...
public class PaperTest extends WithPaperTemplateTest {
    ...
    void before() {
        ...
        this.student2 = this.userTestHelper.createStudent(school, teacher, "student2", "중1");
    ...
    void 시험지_템플릿을_학습자1에게_시험지를_낸다() {
        paperService.publishPaper(paperTemplate.getPaperTemplateId(), List.of(student1.getUserId()));
        ...
        assertEquals(student1.getUserId(), paper.getStudentUserId());
