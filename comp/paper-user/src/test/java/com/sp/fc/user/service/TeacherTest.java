...
public class TeacherTest extends WithUserTest {
    ...
    void 선생님으로_등록한_학생_리스트_조회() {
        this.userTestHelper.createStudent(school, teacher, "student1", "1");
        this.userTestHelper.createStudent(school, teacher, "student2", "1");
        this.userTestHelper.createStudent(school, teacher, "student3", "1");
